...
public interface CustomerDao extends CrudDao<Customer,String> {
    ...
    public boolean updateCustomer(Customer customer) throwsS SQLException, ClassNotFoundException;
    public boolean deleteCustomer(String email) throws SQLException, ClassNotFoundException;
    public Customer findCustomer(String email)throws QLException, ClassNotFoundException;
